# BuddyBridge dispatch launcher (Windows PowerShell)
# 用法: launch.ps1 -WorkDir <dir> [-CliArgs <codebuddy args...>]
...
'CODEBUDDY_CONFIG_DIR','CODEBUDDY_SESSION_ID','CODEBUDDY_MCP_CONFIG',
...
'CODEBUDDY_DISABLE_AUTO_MEMORY','CODEBUDDY_DISABLE_FORK_SUBAGENT' | ForEach-Object {
